...
const Shipping = () => {
  return (
    <>
    <section className='pt-13 pb-12.5 lg:px-0 px-4 border-b border-[#E0E0E0]'>
        <Container>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  items-centerxl:grid-cols-4 gap-6">
